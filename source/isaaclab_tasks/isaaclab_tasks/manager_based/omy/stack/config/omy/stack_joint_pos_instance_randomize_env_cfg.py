...
class EventCfg:
    ...
    randomize_cubes_in_focus = EventTerm(
        func=omy_stack_events.randomize_rigid_objects_in_focus,
        mode="reset",
        params={
...
@configclass
class OMYCubeStackInstanceRandomizeEnvCfg(StackInstanceRandomizeEnvCfg):
    def __post_init__(self):
        ...
        self.actions.gripper_action = mdp.BinaryJointPositionActionCfg(
            ...
            open_command_expr={"rh_.*": 0.04},
            close_command_expr={"rh_.*": 0.0},
        )
        ...
        self.scene.ee_frame = FrameTransformerCfg(
            ...
            target_frames=[
                ...
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/rh_p12_rn_r1",
                ...
                FrameTransformerCfg.FrameCfg(
                    prim_path="{ENV_REGEX_NS}/Robot/rh_p12_rn_l1",
